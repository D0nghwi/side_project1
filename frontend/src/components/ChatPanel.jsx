...
function StudyChatPanel({ noteId, noteTitle, noteContent }) {
    const [messages, setMessages] = useState([
    {
        role: "assistant",
        content:
            `안녕하세요! 저는 StudyI입니다.\n` +
            `지금 보고 있는 노트(번호: ${noteId || "-"} / 제목: ${ noteTitle || "제목 없음"})에 대해 궁금한 점이나,\n` +
        ...
        <div className="flex-1 border border-gray-200 rounded-md p-2 mb-3 overflow-y-auto text-sm bg-gray-50">
            ...
            <div className="mt-auto">
                <textarea
                    ...
                    placeholder="질문을 입력하고 Enter를 눌러 전송 (Shift+Enter 줄바꿈)"
                    value={input}
